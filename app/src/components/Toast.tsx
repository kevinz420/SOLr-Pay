...
export const Toast: React.FC<ToastProps> = (props) => {
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <div className="flex items-center w-full max-w-xs p-4 mb-4 rounded-lg shadow text-gray-900 bg-neutral-200 fixed top-5 right-8 md:bg-gray-800 md:text-gray-500 md:bottom-5">
